...
const (
	// MeshNeighborServiceName is the fully-qualified name of the MeshNeighborService service.
	MeshNeighborServiceName = "openmanet.service.v1.MeshNeighborService"
)
...
// period.
const (
	// MeshNeighborServiceListMeshNeighborsProcedure is the fully-qualified name of the
	// MeshNeighborService's ListMeshNeighbors RPC.
	MeshNeighborServiceListMeshNeighborsProcedure = "/openmanet.service.v1.MeshNeighborService/ListMeshNeighbors"
)
...
func NewMeshNeighborServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) MeshNeighborServiceClient {
...
// MeshNeighborServiceHandler is an implementation of the openmanet.service.v1.MeshNeighborService
// service.
...
func NewMeshNeighborServiceHandler(svc MeshNeighborServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	meshNeighborServiceMethods := v1.File_openmanet_service_v1_mesh_proto.Services().ByName("MeshNeighborService").Methods()
	meshNeighborServiceListMeshNeighborsHandler := connect.NewUnaryHandlerSimple(
		MeshNeighborServiceListMeshNeighborsProcedure,
		svc.ListMeshNeighbors,
		connect.WithSchema(meshNeighborServiceMethods.ByName("ListMeshNeighbors")),
		connect.WithHandlerOptions(opts...),
	)
	return "/openmanet.service.v1.MeshNeighborService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
		case MeshNeighborServiceListMeshNeighborsProcedure:
			meshNeighborServiceListMeshNeighborsHandler.ServeHTTP(w, r)
		default:
			http.NotFound(w, r)
		}
	})
