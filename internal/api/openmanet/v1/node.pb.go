...
type Node struct {
	...
	// UCI DHCP start address
	UciDhcpStart string `protobuf:"bytes,5,opt,name=uci_dhcp_start,json=uciDhcpStart,proto3" json:"uci_dhcp_start,omitempty"`
	// UCI DHCP limit is the number of addresses to reserve
	UciDhcpLimit  string `protobuf:"bytes,6,opt,name=uci_dhcp_limit,json=uciDhcpLimit,proto3" json:"uci_dhcp_limit,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Node) GetUciDhcpStart() string {
	if x != nil {
		return x.UciDhcpStart
	}
	return ""
...
func (x *Node) GetUciDhcpLimit() string {
	if x != nil {
		return x.UciDhcpLimit
	}
	return ""
